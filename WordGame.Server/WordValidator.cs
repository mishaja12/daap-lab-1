...
public class WordValidator
{
    ...
    /// <summary>
    /// Validates that the word exists in the dictionary and uses only letters from the offered set.
    /// Each letter can be used at most as many times as it appears in the offered letters.
    /// </summary>
